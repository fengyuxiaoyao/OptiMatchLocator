...
class SuperPoint(Extractor):
    ...
    def __init__(self, **conf):
        ...
        try:
            ...
            print(f"Failed to load state dict from URL: {e}. Loading local model instead.")
            weight_path = os.path.join(str(path), "weights", "superpoint_v1.pth")
            print(f"Loading local model from {weight_path}")
